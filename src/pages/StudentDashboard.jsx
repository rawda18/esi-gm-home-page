      ...
      <main className="flex-1 overflow-y-auto p-7">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            {stats.map((s) => (
              <div key={s.label} className="rounded-2xl p-4 glass-card border-1 border-[#1E40AF4D] min-h-[109px]">
              ...
              {PROJECTS.map((p) => (
                ...
                >
                  ...
                  <div className="mt-0 pt-0 flex items-center justify-between">
                    <span className="text-[9px] text-small-custom font-inter uppercase tracking-tight">{p.members} team member(s)</span>
          ...
          <div className="rounded-2xl overflow-hidden py-3" style={{ background: "var(--card)", border: "1px solid var(--card-border)" }}>
            ...
            <div className="flex flex-col gap-4 mx-auto max-w-[95%]">
              {REQUESTS.map((r) => (
                <div key={r.id} className="flex items-center justify-between gap-4 px-6 py-3 rounded-xl border-1 border-[var(--card-border)] last:border-0 hover:bg-black/5 transition-all cursor-pointer">
